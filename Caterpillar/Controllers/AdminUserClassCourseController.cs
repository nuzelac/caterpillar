...
{
    public class AdminUserClassCourseController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var userclasscourse = db.UserClassCourses.Include(u => u.Class).Include(u => u.Course).Include(u => u.User);
            return View(userclasscourse.ToList());
        }
